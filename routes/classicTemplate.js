var classic = function(title, content){
	return `<!DOCTYPE html>
				<html lang="en">
				<head>
				...
				<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" bgcolor="#3498db" style="margin:0; padding:0; -webkit-text-size-adjust:none; -ms-text-size-adjust:none;">
				<table cellpadding="0" cellspacing="0" border="0" height="100%" width="100%" bgcolor="#3498db" style="border-collapse:collapse;"><tr><td>
				    <div style="display:none;font-size:1px;color:#fff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide: all;">
				    ...
				    <tr>
				      <td>
				          ...
				          <tr><td height="5" style="font-size: 0; line-height: 0;">&nbsp;</td></tr>
				                ...
				                <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#c0392b">
				                    <tr>
				            <td style="padding: 4%; font-family: sans-serif; font-size: 18px; line-height: 1.3; color: #95a5a6;">
				              ${content}
				            </td>
				          </tr>
				                    <tr>
